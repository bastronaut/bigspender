...
public class SampleData {
    ...
    public static final TransactionImport TRANSACTION_IMPORT = new TransactionImport(getTransactions(), TESTUSERONE);

    public static final Transaction t1TESTUSERTWO = new Transaction(LocalDate.of(2019, 04, 01),
            LocalTime.of(22,39), "AH to go 5869 DenHaa", "NL41INGB0006212385",
            null, GT, AF, 180, BETAALAUTOMAAT,
